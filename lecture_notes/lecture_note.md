...
- 실습 노트북은 저장소의 `lecture_notes/notebooks/` 폴더와 함께 사용하는 것을 권장합니다.
...
- 실습 파일: [00_Data_Loading_and_Exploration.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/00_Data_Loading_and_Exploration.ipynb)
...
- 실습 파일 1: [00_data_preprocessing.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/00_data_preprocessing.ipynb)
- 실습 파일 2: [02_TimeSeries_Decomposition.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/02_TimeSeries_Decomposition.ipynb)
...
- 실습 파일: [03_Stationarity_and_Autocorrelation.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/03_Stationarity_and_Autocorrelation.ipynb)
...
- 실습 파일: [04_ARMA_Modeling.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/04_ARMA_Modeling.ipynb)
...
- 실습 파일: [05_ARIMA_forecasting.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/05_ARIMA_forecasting.ipynb)
...
- 실습 파일: [06_SARIMA_Modeling.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/06_SARIMA_Modeling.ipynb)
...
- 실습 파일: [07_Forecasting_and_Evaluation.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/07_Forecasting_and_Evaluation.ipynb)
...
- 실습 파일 1: [08_VAR_forecasting.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/08_VAR_forecasting.ipynb)
- 실습 파일 2: [08_SVAR_forecasting.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/08_SVAR_forecasting.ipynb)
...
- 실습 파일: [09_GrangerCausality_VAR.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/09_GrangerCausality_VAR.ipynb)
...
- 실습 파일: [10_Cointegration_and_VECM.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/10_Cointegration_and_VECM.ipynb)
...
- 실습 파일: [11_StructuralBreaks_and_Intervention.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/11_StructuralBreaks_and_Intervention.ipynb)
...
- 실습 파일: [12_causal_time_series_intro.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/12_causal_time_series_intro.ipynb)
...
- 실습 파일: [13_ML_DL_Forecasting.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/13_ML_DL_Forecasting.ipynb)
...
- 실습 파일: [14_Domain_Specific_Applications.ipynb](https://github.com/nhjung-phd/TimeSeriesAnalysis/blob/main/lecture_notes/notebooks/14_Domain_Specific_Applications.ipynb)
...
- 강의 노트 내 실습 폴더: [lecture_notes/notebooks](https://github.com/nhjung-phd/TimeSeriesAnalysis/tree/main/lecture_notes/notebooks)
- 저장소 루트 실습 폴더: [notebooks](https://github.com/nhjung-phd/TimeSeriesAnalysis/tree/main/notebooks)
